...
export const metadata: Metadata = {
  ...
  description: "17 free online PDF tools: merge, split, compress, rotate, convert PDF to JPG, sign, watermark, add page numbers, and more. Browser-based — files never leave your device.",
  ...
  openGraph: {
    ...
    description: "17 free browser-based PDF tools. No upload, no account, no software.",
  },
  twitter: {
