...
export const metadata: Metadata = {
  ...
  description:
    "Remove PDF password protection instantly in your browser. Free and unlimited, no sign-up, no uploads. Unlock any password-protected PDF in seconds.",
  keywords: [
    "unlock PDF",
    "remove PDF password",
  ...
  openGraph: {
    title: "Unlock PDF Online Free — Remove Password Instantly",
    description: "Remove PDF password protection instantly in your browser. Free and unlimited, no sign-up required.",
