...
export const metadata: Metadata = {
  ...
  description:
    "All 23 PDF tools free with no limits. Upgrade to Pro for $5/month for unlimited batch processing, bulk CSV unlock, OCR for whole documents, and file history. Cancel any time.",
  keywords: [
    "PDF tools pricing",
    "free PDF tools",
    "RizzPDF pro",
